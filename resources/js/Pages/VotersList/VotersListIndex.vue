    ...
    <AdminLayout>
        ...
        <div class="max-w-full mx-auto py-2">
            <div class="mt-2">
                ...
                <div class="mt-6 md:mt-10">
                    <div class="md:flex justify-between items-baseline lg:gap-2 mb-8">
                        <div class="flex justify-between items-center">
                            <div class="hidden md:flex md:w-[220px] lg:w-[270px] space-x-2">
                            ...
                            <div class="w-full md:flex">
                                <div class="flex md:hidden justify-between text-xs md:text-normal mx-auto">
                                    ...
                                    <div class="">
                                        <button @click="
                                            ...
                                            "
                                            class="flex items-center justify-center border rounded-lg shadow-lg px-6 py-3 text-normal gap-1 bg-purple-500 text-white">
                ...
                <div class="p-2 border md:hidden rounded-lg shadow-lg">
                    ...
                    <div v-if="filterMunicipalityQuery || filterBarangayQuery"
                    ...
                    <div v-if="voters.data && voters.data.length" v-for="(voter, index) in voters.data"
                        ...
                        <div class="text-xs ml-7 text-gray-500">{{ voter.municipality_name }}, {{
                            voter.barangay_name }}
                        </div>
                    </div>

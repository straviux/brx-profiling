                    ...
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                        ...
                        <DialogPanel
                            ...
                            <DialogTitle as="h3"
                                ...
                                <Link class="-mr-4 -mt-4" :href="route('christiancommunity.showposition', {
                            ...
                            <form @submit.prevent="
                                ...
                                <Draggable class="mtl-tree" v-model="treeData" treeLine>
                                    <template #default="{ node, stat }">
                                        <OpenIcon v-if="stat.children.length" :open="stat.open" class="mtl-mr -ml-4"
                                            @click.native="
                                                stat.open = !stat.open
                                                " />
                                ...
                                <div class="flex items-center mt-4 justify-end">
                                    ...
                                    }" class="w-32 justify-center" :disabled="form.processing">
                                        Update
                                    </PrimaryButton>
                                </div>
                            </form>
